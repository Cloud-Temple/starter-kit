...
def get_current_client_name() -> str:
    ...
    Utile pour l'isolation par propriétaire (multi-tenant) :
    chaque client ne voit que ses propres ressources.
...
def is_admin() -> bool:
    ...
    Utile pour les opérations privilégiées (voir toutes les ressources,
    gérer les tokens d'autres clients, etc.).
